...
REASONS = {
    ...
    "account_age_expired": "账户容量确认已过期", "account_margin_status_unknown": "历史旧版记录：未载入融资字段（无需重复确认）",
    "account_margin_balance_unknown": "历史旧版记录：未载入借款字段（无需重复确认）", "account_margin_active": "账户记录有融资或借贷余额",
    ...
    "cash_insufficient": "指派金额超过剩余现金；需关注融资需求、保证金与流动性",
    "margin_capacity_exceeded": "指派金额超过剩余现金的 2 倍容量上限",
    "nav_ratio": "指派后该标的敞口超过原设 NAV 比例偏好，请关注集中度",
