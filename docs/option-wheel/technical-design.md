...
> 历史 M1 技术设计。账户容量门控、融资确认和暂停总闸均不属于 2026-09-24 现行筛选需求；
> 当前行为以 [产品需求](product-requirements.md) 和 [新版筛选说明](screening-v2.md) 为准。

> 2026-09-21 用户更新：本文件早期全额现金担保与 NAV 硬门槛章节已被
> 当时的两倍现金口径取代；该 2026-09-21 口径现也已被 2026-09-22 现行要求取代。
